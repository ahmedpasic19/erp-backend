...
export const UpdateInvoiceArticleDto = z.object({
  id: z.coerce.number().min(1, 'Must provide invoiceArticleId'),
...
export type UpdateInvoiceArticleDto = z.infer<typeof UpdateInvoiceArticleDto>;
